...
export default function Songs() {
  ...
  const [dominantColor, setDominantColor] = useState("#ccc");
      ...
      <div className="w100 pl4 songs-main">
        ...
        {songs.map((song, index) => (
          <div
            ...
            onTouchEnd={() => handleTouch(song.id)}
            className={
          ...
          >
            ...
            <div className={song.isHovered ? "white date-added" : "date-added"}>
              {song.dateAdded}
            </div>
        ...
        <div className="flex flex-column pt75">
          ...
          <div className="playing-container">
            ...
            <div className="grey font-size085 circularLight pl1">
              {"-"}
              {currentSongAudio ? remainingMinutes : " "}:
              {/* remaining seconds */}
              {currentSongAudio
                ? remainingSeconds < 10
                  ? "0" + remainingSeconds
      ...
      >
        <div className="flex justify-between">
          ...
          <div className="play-btn-mobile">
            ...
            <div onTouchEnd={() => handleTouch(currentSongData.id)}>
              {currentSongData.isPlaying ? (
                <i className="fa-solid fa-pause play-pause-btns" />
              ) : (
                <i className="fa-solid fa-play play-pause-btns" />
